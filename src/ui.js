...
const uiModule = (function () {
  ...
  function initBtnListeners() {
    ...
    menuButton.addEventListener("click", () => {
      ...
      mainSection.classList.toggle("show-aside");
    });
      ...
      if (taskCard) {
        ...
        if (task) {
          if (target.classList.contains("task-name")) {
            ...
            const taskDueDate = target
              .closest(".task-card")
              .querySelector("#task-due-date");
            createEditableDateElement(
              taskDueDate,
  ...
  function toggleTaskSection(section) {
    ...
    importantTasksContainer.style.display =
      section === "importantTasks" ? "block" : "none";
    todayTasksContainer.style.display =
      section === "todayTasks" ? "block" : "none";
  }

  function hidePages() {
    const projectPageContainers = document.querySelectorAll(
