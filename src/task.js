...
const taskModule = (function () {
    ...
    function updatePriorityToggleVisual(priorityToggle, priority) {
        priorityToggle.style.backgroundColor = priority === 'important' ? '#FF0000' : '#2ABD67';
    }
    ...
    function updateTaskUI(task, container) {
        ...
        if (task.priority === 'important') {
            ...
            const importantTasks = importantTasksContainer.querySelectorAll('.task-card');
    ...
    return { createTask, createTaskCard, handleFormSubmit, displayTasksForToday, displayImportantTasks, taskList, renderAllSections, toggleTaskPriority, deleteTask }
})()
